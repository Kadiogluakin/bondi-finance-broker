# Community
Source: https://elizaos.github.io/eliza/community/

IntroductionOn this pageWelcome to the ai16z / ElizaOS Community
...
AI Agent Dev School: Start your journey with our comprehensive series on agent development
Tutorials: Follow step-by-step guides to build and integrate AI agents
API Reference: Explore the ElizaOS API documentation
Contributing Guide: Learn how you can contribute to ElizaOS
Roadmap: Discover future plans and priorities for ElizaOS development
Community Showcase: Get inspired by projects built with ElizaOS and share your own creations
Events and Updates: Stay informed about the latest happenings in the ai16z community
FAQ and Support: Find answers to common questions and get support
