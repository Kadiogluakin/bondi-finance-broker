...
🧠 Core ConceptsCharacter FilesOn this page📝 Character Files
...
Specifies the AI model provider. Supported options from ModelProviderName include anthropic, llama_local, openai, livepeer, and others.
clients (required)​
...
Model Providers
Client Integration
Edit this pageLast updated on Jan 17, 2025 by George P.