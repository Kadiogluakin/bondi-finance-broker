...
Source: https://elizaos.github.io/eliza/docs/faq/

🏁 Getting Started❓ FAQOn this pageFrequently Asked Questions
Eliza FAQ​
What is Eliza?​
...
Set up your environment: Create a .env file and populate it with the required API keys, database configuration, and platform-specific tokens.
Install Eliza: Use the command npm install @elizaos/core or pnpm add @elizaos/core to install the Eliza package.
Configure your database: Eliza currently relies on Supabase for local development. Follow the instructions in the documentation to set up your Supabase project and database.
...
Run Eliza locally: Use the provided commands to start the Eliza framework and interact with your agent.
...
Edit this pageLast updated on Jan 10, 2025 by itsasecret