# WSL Setup Guide
Source: https://elizaos.github.io/eliza/docs/guides/wsl/

📘 GuidesWSL SetupOn this pageWSL Setup Guide
Steps to run Eliza on Windows computer using WSL.
AI Dev School Tutorial
Install WSL​
...
sudo chown -R $USER:$USER ~/path/to/elizaEdit this pageLast updated on Jan 5, 2025 by Shaw